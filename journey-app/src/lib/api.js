...
export const ai = {
  ...
  funnel: (token) => req('/api/ai', '/analytics/funnel', { headers: { Authorization: `Bearer ${token}` } }),
  bookingInsights: (token) => req('/api/ai', '/insights/bookings', { headers: { Authorization: `Bearer ${token}` } }),
